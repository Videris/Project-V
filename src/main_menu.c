...
static const u8 *const sMalePresetNames[] = {
    gText_DefaultNameEmil,
};

static const u8 *const sFemalePresetNames[] = {
    gText_DefaultNameGerty,
};
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_GROWLITHE_HISUIAN);
...
{
    return CreateMonPicSprite_Affine(SPECIES_GROWLITHE_HISUIAN, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
