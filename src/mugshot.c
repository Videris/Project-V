...
#define MUGSHOT_PALETTE_NUM 13
 ...
 static const u32 sMugshotImg_Paper1[] = INCBIN_U32("/Users/Divas/ROMHACK/WIP/Project-V/graphics/mugshots/paper1.4bpp.lz");
 static const u16 sMugshotPal_Paper1[] = INCBIN_U16("/Users/Divas/ROMHACK/WIP/Project-V/graphics/mugshots/paper1.gbapal");
...
static const struct Mugshot sMugshots[] = {
    ...
    [MUGSHOT_PAPER1] = {.x = 8, .y = 5, .width = 128, .height = 64, .image = sMugshotImg_Paper1, .palette = sMugshotPal_Paper1}
