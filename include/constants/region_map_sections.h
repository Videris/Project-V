...
#define MAPSEC_SAGECREEK_TOWN               0xD5
#define MAPSEC_SAGECREEK_PORT               0xD6
#define MAPSEC_CHERVIL_LANE                 0xD7
#define MAPSEC_EAST_FENNELWOOD              0xD8
#define MAPSEC_THYMEBORO                    0xD9
#define MAPSEC_KOMBU_COAST                  0xDA
#define MAPSEC_PERILLA_PASS                 0xDB
#define MAPSEC_BASILBY                      0xDC
#define MAPSEC_BASILBY_BROOK                0xDD
#define MAPSEC_LAKE_CASSIA                  0xDE
#define MAPSEC_ORRIS_RIVER                  0xDF
#define MAPSEC_MINTFORD                     0xE0
#define MAPSEC_MINTFORD_BRIDGE              0xE1
#define MAPSEC_NEW_MINTFORD                 0xE2
#define MAPSEC_PEPPERMINT_PATH              0xE3
#define MAPSEC_PEPPERTON                    0xE4
#define MAPSEC_PEPPERTON_BEACH              0xE5
#define MAPSEC_SCOVILLE_POOL                0xE6
#define MAPSEC_CAPER_TRAIL                  0xE7
#define MAPSEC_BURNET_HILLS                 0xE8
#define MAPSEC_CARA_WAY_NORTH               0xE9
#define MAPSEC_CLOVEHAM                     0xEA
#define MAPSEC_CARA_WAY_SOUTH               0xEB
#define MAPSEC_MACEPORT_CITY                0xEC
#define MAPSEC_MACEPORT_BAY                 0xED
#define MAPSEC_RUTA_ROAD                    0xEE
#define MAPSEC_CRESSVALE                    0xEF
#define MAPSEC_WEST_FENNELWOOD              0xF0
#define MAPSEC_SUMAC_TRACK                  0xF1
#define MAPSEC_ORRIS_RAPIDS                 0xF2
